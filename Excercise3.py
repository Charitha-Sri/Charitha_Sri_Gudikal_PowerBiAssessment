...
# Example Usage
add_student("Charitha", 20, 75, 90, 75, major="Computer Science")
add_student("Manaswini", 21, 45, 50, 55, major="Mathematics")
add_student("Sindhu", 22, 70, 65, major="Physics")
add_student("Devdutt", 25, major="History") 
...
"""
OUTPUT:
Function 'add_student' called with args: ('Charitha', 20, 75, 90, 75) kwargs: {'major': 'Computer Science'}
Function 'add_student' returned: None
Function 'add_student' called with args: ('Manaswini', 21, 45, 50, 55) kwargs: {'major': 'Mathematics'}
Function 'add_student' returned: None
Function 'add_student' called with args: ('Sindhu', 22, 70, 65) kwargs: {'major': 'Physics'}
Function 'add_student' returned: None
Function 'add_student' called with args: ('Devdutt', 25) kwargs: {'major': 'History'}
Function 'add_student' returned: None
